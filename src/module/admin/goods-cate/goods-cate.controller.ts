...
import { Body, Controller, Get, Post, Query, Render, UseInterceptors, UploadedFile, Response } from '@nestjs/common';
...
export class GoodsCateController {
    constructor(private goodsCateService: GoodsCateService,
